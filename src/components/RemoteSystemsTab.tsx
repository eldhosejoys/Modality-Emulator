...
interface SystemListProps {
  ...
  onAdd: (type: 'ris' | 'pacs') => void;
  onRemove: (type: 'ris' | 'pacs', id: string) => void;
  onUpdate: (type: 'ris' | 'pacs', id: string, updates: Partial<api.RemoteSystem>) => void;
}

const SystemList = ({ type, list, selectedId, onSelect, onAdd, onRemove, onUpdate }: SystemListProps) => (
  ...
  return (
    <div className="w-full space-y-8">
      <SystemList 
        type="ris" 
        list={risList} 
        selectedId={selectedRisId} 
        onSelect={setSelectedRisId}
        onAdd={addSystem}
      ...
      <SystemList 
        type="pacs" 
        list={pacsList} 
        selectedId={selectedPacsId} 
        onSelect={setSelectedPacsId}
        onAdd={addSystem}
        onRemove={removeSystem}
        onUpdate={updateSystem}
      />
